...
import { useGetUserBookingHistoryQuery } from '../../../__redux__/api/auth.api';
...
const UserBookingHistory = () => {
    ...
    const { data: orders, isLoading, isError } = useGetUserBookingHistoryQuery({ id, page, limit });
    ...
    const Table = TableHOC(columns, rows, 'dashboard-product-box', 'User Booking History', true, paginationInfo)();
