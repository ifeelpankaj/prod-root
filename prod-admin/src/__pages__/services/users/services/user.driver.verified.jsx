...
const TotalVerifiedDriver = () => {
    ...
    const Table = TableHOC(columns, rows, 'dashboard-product-box', 'Verified Drivers', true, paginationInfo)();
...
export default TotalVerifiedDriver;
