...
import { useFetchAllUsersQuery } from '../../../../__redux__/api/admin.api';
...
const TotalPassengers = () => {
    ...
    const { data: adminUser, isLoading: usersLoading, isError } = useFetchAllUsersQuery({ page, limit, role });
    ...
    const Table = TableHOC(columns, rows, 'dashboard-product-box', 'Passenger', true, paginationInfo)();
    return (
