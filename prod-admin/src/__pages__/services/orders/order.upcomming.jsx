...
import { useAllUpcommingOrdersQuery } from '../../../__redux__/api/admin.api';
...
const UpcommingBookings = () => {
    ...
    const limit = 6;
    const { data: adminOrders, isLoading: ordersLoading, isError } = useAllUpcommingOrdersQuery({ page, limit });
    ...
    const Table = TableHOC(columns, rows, 'dashboard-product-box', 'Upcomming/Current Bookings', true, paginationInfo)();
