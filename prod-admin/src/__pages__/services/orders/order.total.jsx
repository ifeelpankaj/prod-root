...
const TotalOrder = () => {
    ...
    const limit = 6;
    const { data: adminOrders, isLoading: ordersLoading, isError } = useFetchAllOrdersQuery({ page, limit });
    ...
    const Table = TableHOC(columns, rows, 'dashboard-product-box', 'Bookings', true, paginationInfo)();
